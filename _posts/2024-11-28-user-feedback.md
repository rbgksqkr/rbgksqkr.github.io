...
## 추가 개선 사항 (2024.10.30 - 2025.01.12)
...
## 🔍 GA 사용자 지표 분석 (2024.08.05 - 2025.05.06)

GA를 설정한 시점부터 현재까지의 사용자 지표를 분석하였다.

대화 주제 제공이 핵심 목표인 점에서 **평균 참여 시간** `7분 37초` 로 유의미한 지표를 얻었다.

**누적 페이지 조회 수** `6.5만회`를 기록하였고, `1600명+`의 **활성 사용자**가 존재한다.

**IOS 유저가** Android 유저보다 **약 3배정도 많고**, 브라우저는 `Chrome` 을 가장 많이 사용한다.

<img width="700" alt="땅콩 GA" src="https://github.com/user-attachments/assets/65dfebd1-41df-432e-8654-ad9476da12b9" />
